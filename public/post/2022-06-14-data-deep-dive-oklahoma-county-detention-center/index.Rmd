...
total_bookings <- book_data |> n_distinct("book_num", na.rm = T)
...
-   Jail-assigned classifications (minimum / medium / maximum security, etc.; "General Population", "Protected Custody", etc.)
...
## 3. Who is in the jail, for how long?
